			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<table class="table table-bordered">
						<tr>
							<td style = "font-weight:bold; background-color: orange; color:white">Name</td>
							<td><?php echo $_SESSION['admin_name'];?></td>
						</tr>
						<tr>
							<td style = "font-weight:bold; background-color: orange; color:white">Username</td>
							<td><?php echo $_SESSION['admin_username'];?></td>
						</tr>
						<tr>
							<td style = "font-weight:bold; background-color: orange; color:white">User type</td>
