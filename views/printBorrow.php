		...
		<tbody>
			<tr>
				...
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					...
					<p style="margin:0;padding:0;font-weight:bold;">F.L. Vargas College, Inc. - Tuguegarao Campus</p>
					<p style="margin:0;padding:0;">Tuguegarao City, Cagayan 3500</p>
				</td>
					...
					<table style="width:100%; border:1px solid #000; border-bottom: none;" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								...
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000; border-left:1px solid #000;">Name</th>
							</tr>
						</thead>
						<tbody>
