		...
		$('#calendar').fullCalendar({
	      ...
	      events: {
	      	...
	      	eventRender: function(event, element) {
	        	// Check if the event is unavailable (you can modify the condition as needed)
	        	if (event.status === 'unavailable') {
	        		// Apply a red background to unavailable dates
	        		element.css('background-color', 'red');
	        		element.css('color', 'white'); // Optional: Change text color to white
	        	}
	      	}
	      },
	      editable: false,
	      droppable: false,
	      // Enable window resize handling to adjust the calendar view on screen resize
