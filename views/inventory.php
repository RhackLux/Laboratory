				...
				<div class="row">
					<div class="col-md-12">
						<ul class="nav nav-pills"> 
							<li class="active"><a href="#new" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;Old/New Equipment</a></li>
							<li><a href="#pulledout" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;Borrowed Equipment</a></li>
							<li><a href="#lost" data-toggle="tab"><i class=""></i>&nbsp;&nbsp;Returned Equipment</a></li>
