...
<div class="container vh-100 d-flex justify-content-end align-items-center" style="background-image: url('bg-images/n.jpg'); background-size: cover; background-position: center;">
    <div class="col-md-4">
        <!-- Login Form Section -->
		<div class="login-panel panel shadow-sm rounded" style="margin-top: 30px;">

		<div class="panel-heading text-center py-3" style="background-color: #f57200; color: white; font-weight: bold; border-radius: 5px 5px 0 0;">
    ...
    .form-group {
        position: relative; /* Ensures the icon is positioned relative to this container */
                        ...
                        <button class="btn btn-primary btn-block" style="background-color: #f57200; border: none; padding: 12px; font-weight: bold; border-radius: 4px;">Log in</button>
                        <br>
                        <div class="text-center mt-3">
                            <a href="./member/login" style="color: #007bff;">Go to Member's Page</a>
                        </div>
                    </fieldset>
                </form>
            </div>
