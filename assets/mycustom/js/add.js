...
// $('.frm_room_name').submit(function(e){
...
//     $.ajax({
//         type: "POST",
//         url: "../class/add/add",  // Adjust this to the actual PHP file URL
//         data: {  
//             name: a.val(),
//             key: 'add_room_name'
//         }
...
//         if(datas == 1){
//             toastr.success("Room added.");
//             table_room.ajax.reload(null, false);  // Reload table if necessary
//             $('.cancel_room').click();  // Trigger cancel button to close the form
//         } else if(datas == 2){
//             toastr.warning("Room already exists.");
//         } else if(datas == 0){
//             toastr.error("Failed to add room.");
//             $('.cancel_room').click();
//         }
//     })
//     .fail(function(datas){
//         console.log("Error:", datas);  // Log error to console for debugging
//     });
// });
