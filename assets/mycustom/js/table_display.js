var table_room =  $('.table_room').DataTable({
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="https://res.cloudinary.com/dg9h7lbrw/image/upload/v1726754323/u1yx92v6cdtiegutxf2t.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">REPUBLIC OF THE PHILIPPINES</h4>\
...
var table_equipment = $('.table_equipment').DataTable({ 
	...
	"columns": [
	    {
	        "data": [0],                 // Column 1: Image
	        "className": "text-left"
	    },
	    {
	        "data": [1],                 // Column 2: Model
	        "className": "text-left"
	    },
	    {
	        "data": [2],                 // Column 3: Category
	        "className": "text-left"
	    },
	    {
	        "data": [3],                 // Column 4: Brand
	        "className": "text-left"
	    },
	    {
	        "data": [4],                 // Column 5: Description
	        "className": "text-left"
	    },
	    {
	        "data": [5],                 // Column 6: Quantity Left
	        "className": "text-left"
	    },
	    {
	        "data": [6],                 // Column 7: Status
	        "className": "text-left"
	    },
	    {
	        "data": [7],                 // Column 8: Action
	        "className": "text-left"
	    }
	],
	dom: "Bfrtip",
	buttons: [
		{
			...
			className: "btn-sm btn-success",
			exportOptions: {
				columns: [0, 1, 2, 3, 4, 5, 6]  // Only exporting relevant columns
			}
		},
		// {
		// 	extend: "csv",
...
var table_inventory_new = $('.table_inventory_new').DataTable({
    ...
    buttons: [
        ...
        },
        {
            ...
            message: '<img src="https://res.cloudinary.com/dg9h7lbrw/image/upload/v1726754323/u1yx92v6cdtiegutxf2t.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">REPUBLIC OF THE PHILIPPINES</h4><h4>F.L. VARGAS COLLEGE, INC. - TUGUEGARAO CITY CAMPUS</h4><h6>Tuguegarao City, Cagayan 3500</h6></center>',
            customize: function (win) {
				$(win.document.body).find( 'table' ).append('<br<br/><br><br><br><h4 class="">Prepared by: </h4><br><br><br><br><br><h4 class="">Approved by:</h4>');
            }
        }
